...
# --- 3. PREMIUM UI CSS (Fixed Visibility & CMP Header) ---
st.markdown("""
<style>
.block-container { padding-top: 1rem; padding-bottom: 0rem; max-width: 800px; }

/* Fixed High-Visibility Header */
...
<div class="header-value" style="color: #00ffcc !important;">{countdown_str}</div>
</div>
</div>
""", unsafe_allow_html=True)
...
<div class="sq-data-row"><span class="sq-label">Stop</span><span class="sq-
